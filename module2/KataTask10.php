...
$object_oriented_php = new class {
	...
	public function __construct()
	{
		$this->author = new class {
			...
			{
				return "{$this->name}, aged {$this->age}, who is a "
					. strtolower($this->occupation) . " proficient in Javascript and PHP and is a PHP enthusiast";
			}
		};
	}
	...
	{
		if (!is_int($kata_number) || $kata_number < 1 || $kata_number > $this->kata_count) {
